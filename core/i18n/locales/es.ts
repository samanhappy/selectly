...
export const es: I18nConfig = {
  ...
  popup: {
    ...
    general: {
      ...
      showTabAssistantButton: 'Mostrar botón para preguntar a la página',
      tabAssistantBlacklist: 'Lista negra para preguntar a la página',
      tabAssistantBlacklistDesc:
        'Un dominio por línea. El botón para preguntar a la página se oculta en estos sitios.',
  ...
  content: {
    ...
    askPage: 'Preguntar a esta página',
  },

  tabAssistant: {
    title: 'Preguntar a esta página',
    noPageTitle: 'Página actual',
    sharing: 'Compartiendo',
    noPageContext: 'Sin contexto de página',
    contextReady: 'Contexto de página listo',
    contextUnavailable: 'No se puede leer esta página',
    contextTruncated: 'Contexto truncado',
    contextStats: '{{chars}} caracteres · {{blocks}} bloques',
    skippedFrames: '{{count}} marcos omitidos',
    selectedText: 'Texto seleccionado',
    expandSelectedText: 'Mostrar más',
    collapseSelectedText: 'Mostrar menos',
    removeSelectedText: 'Quitar texto seleccionado',
    newChat: 'Nuevo chat',
    chatHistory: 'Historial de chat',
    currentChat: 'Actual',
    noPreviousChats: 'No hay chats anteriores para esta página',
    messageCount: '{{count}} mensajes',
    updatedAt: 'Actualizado {{time}}',
    closeChatHistory: 'Cerrar historial de chat',
    viewContext: 'Ver contenido extraído',
    contextPreviewTitle: 'Contenido extraído',
    contextPreview: 'Vista previa',
    contextBlocks: 'Bloques',
    contextSource: 'Origen',
    contextFrame: 'Marco',
    contextBlockChars: '{{chars}} caracteres',
    copyContext: 'Copiar contexto',
    contextCopied: 'Contexto copiado',
    closeContextPreview: 'Cerrar vista previa del contexto',
    refresh: 'Actualizar contexto',
    pin: 'Anclar sesión',
    unpin: 'Desanclar sesión',
    pinned: 'Anclado',
