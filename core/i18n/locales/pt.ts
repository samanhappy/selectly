...
export const pt: I18nConfig = {
  ...
  popup: {
    ...
    general: {
      ...
      showTabAssistantButton: 'Mostrar botão de perguntar à página',
      tabAssistantBlacklist: 'Lista negra de perguntar à página',
      tabAssistantBlacklistDesc:
        'Um domínio por linha. O botão de perguntar à página fica oculto nesses sites.',
      debugEnabled: 'Ativar registro de depuração',
      debugEnabledDesc: 'Mostrar logs detalhados no DevTools para solução de problemas',
    },
    subscription: {
      signIn: 'Entrar',
      signOut: 'Sair',
  ...
  content: {
    ...
    askPage: 'Perguntar a esta página',
  },

  tabAssistant: {
    title: 'Perguntar a esta página',
    noPageTitle: 'Página atual',
    sharing: 'Compartilhando',
    noPageContext: 'Sem contexto da página',
    contextReady: 'Contexto da página pronto',
    contextUnavailable: 'Não foi possível ler esta página',
    contextTruncated: 'Contexto truncado',
    contextStats: '{{chars}} caracteres · {{blocks}} blocos',
    skippedFrames: '{{count}} frames ignorados',
    viewContext: 'Ver conteúdo extraído',
    contextPreviewTitle: 'Conteúdo extraído',
    contextPreview: 'Prévia',
    contextBlocks: 'Blocos',
    contextSource: 'Fonte',
    contextFrame: 'Quadro',
    contextBlockChars: '{{chars}} caracteres',
    copyContext: 'Copiar contexto',
    contextCopied: 'Contexto copiado',
    closeContextPreview: 'Fechar prévia do contexto',
    ...
    send: 'Enviar',
    configureModel: 'Configure um modelo para começar a conversar.',
    openSettings: 'Abrir configurações',
    saveSession: 'Salvar sessão',
    saveToCollections: 'Salvar nas Coleções',
    saved: 'Salvo',
    copy: 'Copiar',
    summarizePage: 'Resumir',
    askAboutPage: 'Perguntar sobre esta página',
    askAboutPagePrompt: 'O que devo entender sobre esta página?',
    translatePage: 'Traduzir',
    loadingContext: 'Lendo página...',
    pageBriefTitle: 'Pronto para entender esta página',
    pageBriefDescription: 'Faça uma pergunta objetiva ou comece com um resumo curto.',
  ...
  defaultFunctions: {
    ...
    collect: {
      title: 'Coletar',
      description: 'Salvar texto selecionado em coleções',
      prompt: '{text}',
    },
    share: {
      title: 'Compartilhar',
