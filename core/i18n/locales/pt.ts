...
export const pt: I18nConfig = {
  ...
  tabAssistant: {
    ...
    selectedText: 'Texto selecionado',
    expandSelectedText: 'Mostrar mais',
    collapseSelectedText: 'Mostrar menos',
    removeSelectedText: 'Remover texto selecionado',
    newChat: 'Novo chat',
    chatHistory: 'Histórico de chat',
    currentChat: 'Atual',
    noPreviousChats: 'Nenhum chat anterior para esta página',
    messageCount: '{{count}} mensagens',
    updatedAt: 'Atualizado {{time}}',
    closeChatHistory: 'Fechar histórico de chat',
