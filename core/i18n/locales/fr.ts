...
export const fr: I18nConfig = {
  ...
  popup: {
    ...
    models: {
      ...
      contextWindowHelp: "Optionnel. Aide le chat d'onglet avec les pages plus longues.",
    },
    functions: {
      title: 'Fonctions',
      ...
      labels: {
        ...
        thinkingModeAuto: 'Automatique',
        thinkingModeEnabled: 'Activé',
        thinkingModeDisabled: 'Désactivé',
        thinkingModeHelp: 'Automatique convient à la plupart des actions.',
  ...
  tabAssistant: {
    ...
    selectedText: 'Texte sélectionné',
    expandSelectedText: 'Afficher plus',
    collapseSelectedText: 'Afficher moins',
    removeSelectedText: 'Retirer le texte sélectionné',
    newChat: 'Nouvelle discussion',
    chatHistory: 'Historique des discussions',
    currentChat: 'Actuelle',
    noPreviousChats: 'Aucune discussion précédente pour cette page',
    messageCount: '{{count}} messages',
    updatedAt: 'Mis à jour {{time}}',
    closeChatHistory: "Fermer l'historique des discussions",
    viewContext: 'Voir le contenu extrait',
    contextPreviewTitle: 'Contenu extrait',
    contextPreview: 'Aperçu',
    contextBlocks: 'Blocs',
    contextSource: 'Source',
    contextFrame: 'Cadre',
    contextBlockChars: '{{chars}} caractères',
    copyContext: 'Copier le contexte',
    contextCopied: 'Contexte copié',
    closeContextPreview: "Fermer l'aperçu du contexte",
  ...
  errors: {
    ...
    llmReasoningRequiredError:
      'Ce modèle a besoin du mode de réflexion. Utilisez Automatique, activez-le ou choisissez un autre modèle.',
