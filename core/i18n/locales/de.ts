...
export const de: I18nConfig = {
  ...
  popup: {
    ...
    general: {
      ...
      showTabAssistantButton: 'Schaltfläche Seite fragen anzeigen',
      tabAssistantBlacklist: 'Blacklist für Seite fragen',
      tabAssistantBlacklistDesc:
        'Eine Domain pro Zeile. Auf diesen Websites wird die Schaltfläche Seite fragen ausgeblendet.',
  ...
  content: {
    ...
    askPage: 'Diese Seite fragen',
  },

  tabAssistant: {
    title: 'Diese Seite fragen',
    noPageTitle: 'Aktuelle Seite',
    sharing: 'Teilen',
    noPageContext: 'Kein Seitenkontext',
    contextReady: 'Seitenkontext bereit',
    contextUnavailable: 'Diese Seite kann nicht gelesen werden',
    contextTruncated: 'Kontext gekürzt',
    contextStats: '{{chars}} Zeichen · {{blocks}} Blöcke',
    skippedFrames: '{{count}} Frames übersprungen',
    selectedText: 'Ausgewählter Text',
    expandSelectedText: 'Mehr anzeigen',
    collapseSelectedText: 'Weniger anzeigen',
    removeSelectedText: 'Ausgewählten Text entfernen',
    newChat: 'Neuer Chat',
    chatHistory: 'Chatverlauf',
    currentChat: 'Aktuell',
    noPreviousChats: 'Keine vorherigen Chats für diese Seite',
    messageCount: '{{count}} Nachrichten',
    updatedAt: 'Aktualisiert {{time}}',
    closeChatHistory: 'Chatverlauf schließen',
    viewContext: 'Extrahierten Inhalt anzeigen',
    contextPreviewTitle: 'Extrahierter Inhalt',
    contextPreview: 'Vorschau',
    contextBlocks: 'Blöcke',
    contextSource: 'Quelle',
    contextFrame: 'Frame',
    contextBlockChars: '{{chars}} Zeichen',
    copyContext: 'Kontext kopieren',
    contextCopied: 'Kontext kopiert',
    closeContextPreview: 'Kontextvorschau schließen',
    refresh: 'Kontext aktualisieren',
    pin: 'Sitzung anheften',
    unpin: 'Sitzung lösen',
    pinned: 'Angeheftet',
    placeholder: 'Fragen Sie zu dieser Seite...',
    send: 'Senden',
