...
export const en: I18nConfig = {
  ...
  popup: {
    ...
    general: {
      ...
      showTabAssistantButton: 'Show Ask page button',
      tabAssistantBlacklist: 'Ask page blacklist',
    ...
    subscription: {
      ...
      featuresModels: 'Advanced Models Access (pay-as-you-go)',
      featuresSync: 'Unlimited cloud sync across devices',
  ...
  tabAssistant: {
    title: 'Ask this page',
    noPageTitle: 'Current page',
    sharing: 'Sharing',
    noPageContext: 'No page context',
    contextReady: 'Page context ready',
    contextUnavailable: 'This page cannot be read',
    contextTruncated: 'Context truncated',
    contextStats: '{{chars}} chars · {{blocks}} blocks',
    skippedFrames: '{{count}} frames skipped',
    viewContext: 'View extracted content',
    contextPreviewTitle: 'Extracted content',
    contextPreview: 'Preview',
    contextBlocks: 'Blocks',
    contextSource: 'Source',
    contextFrame: 'Frame',
    contextBlockChars: '{{chars}} chars',
    copyContext: 'Copy context',
    contextCopied: 'Context copied',
    closeContextPreview: 'Close context preview',
